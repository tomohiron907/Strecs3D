...
InfillStepWidget::InfillStepWidget(QWidget* parent) : QWidget(parent) {
    ...
    // Density Slider
    m_densitySlider = new DensitySlider(this);
    ...
    m_processButton->setIcon(":/resources/icons/process.png"); // Reuse existing icon path assumption
...
void InfillStepWidget::setUIState(UIState* uiState) {
    ...
    connect(m_densitySlider, &DensitySlider::regionPercentsChanged,
    ...
    connect(m_densitySlider, &DensitySlider::handlePositionsChanged,
